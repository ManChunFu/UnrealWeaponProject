...
AProjectile* UProjectileComponent::FireProjectile(TSubclassOf<AProjectile> ProjectileClass,  AActor* Owner, FTransform CameraTransform, FTransform SpawnLocation, float SpeedMultiplier)
{
